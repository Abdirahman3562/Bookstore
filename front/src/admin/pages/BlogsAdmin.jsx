    ...
    <div className="p-4 sm:p-6 w-full">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 p-6 rounded-xl text-white shadow-lg">
          ...
          <div>
            <p className="text-cyan-100 text-sm font-medium">Total Posts</p>
            <p className="text-3xl font-bold">{stats.totalBlogs}</p>
          </div>
        </div>

        <div className="bg-gradient-to-br from-lime-500 to-lime-600 p-6 rounded-xl text-white shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <Eye className="w-8 h-8 opacity-80" />
            <CheckCircle className="w-5 h-5 opacity-60" />
          </div>
          <div>
            <p className="text-lime-100 text-sm font-medium">Published</p>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl lg:ml-40 md:ml-40 ml-0 w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky z-[10000] top-0 bg-gradient-to-r from-cyan-600 to-blue-600 p-6 flex items-center justify-between">
                ...
                <div className="md:col-span-2">
                  ...
                  {editor && (
                    <div className="border border-gray-300 border-b-0 rounded-t-lg bg-gray-50 p-2 flex flex-wrap gap-2">
                      ...
                      <div className="w-px h-6 bg-gray-300"></div>
                      <label
                        className="p-2 rounded hover:bg-gray-200 cursor-pointer inline-flex items-center"
                        title="Insert Image"
                      >
                  ...
                  {/* Editor Content */}
                  <div className="border border-gray-300 rounded-b-lg h-[450px] overflow-y-auto p-4 prose prose-sm max-w-none">
      ...
      {showCommentsModal && blogForComments && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full h-[90vh] sm:h-[85vh] flex flex-col overflow-hidden">
            <div className="sticky z-[10000] top-0 bg-gradient-to-r from-cyan-600 to-blue-600 p-4 sm:p-6 flex items-center justify-between flex-shrink-0">
                ...
                <div className="space-y-6">
                  {blogForComments.comments.map((comment, index) => {
                    ...
                    const renderReplies = (replies, depth = 0, parentCommentId = null) => {
                      ...
                      return (
                        <div
                          className="mt-3 space-y-3 border-l-2 border-gray-200 pl-2 sm:pl-4"
                            ...
                            <div key={reply.id || reply._id} className="space-y-2">
                              <div className="flex items-start gap-1.5 sm:gap-3">
                                ...
                                <button
                                  ...
                                  className="p-1.5 sm:p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors flex-shrink-0 mt-0.5"
                                  title="Delete reply"
                                >
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-1.5 sm:gap-3">
                          ...
                          <div 
                            className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-200 flex items-center justify-center flex-shrink-0 avatar-fallback ${comment.avatar && comment.avatar.trim() !== "" ? "hidden" : ""}`}
                          >
                          ...
                          <div className="flex-1 min-w-0 pr-1 sm:pr-2">
                            ...
                            <p className="text-gray-700 text-sm sm:text-base whitespace-pre-wrap break-words mb-2">
                          ...
                          <button
                            ...
                            className="p-1.5 sm:p-2.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors flex-shrink-0 mt-0.5"
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
                >
                  <Trash2 className="w-4 h-4" />
                  {commentToDelete.replyId ? "Delete Reply" : "Delete Comment"}
                </button>
